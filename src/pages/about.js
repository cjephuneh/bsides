  ...
  return (
    <div>
      ...
      <div className="h-[1000px]">
        ...
        <span className="mt-5 text-gray-500 font-semibold text-[23px] ml-[150px] space-x-4 block mb-20 leading-8 tracking-wide">
        ...
        <div className="bg-gray-100 p-8 flex-col space-y-8 h-[800px] absolute w-full">
          <div className="bg-gray-100 p-8 flex-col space-y-8 h-[700px] absolute w-full">
            <div className="w-full md:w-[500px] flex ml-[150px] mb-10">
              <img
                src={Lawrence}
                alt="Sponsor 1"
                width={100}
              ...
              />
              <div className="pl-8 flex-grow w-full absolute ml-[200px] mt-[20px] mb-2">
            ...
            <div className="w-full md:w-[500px] flex ml-[150px] mb-10">
              <img
                ...
                className="rounded-full h-40 w-40 object-cover"
              />
              <div className="pl-8 flex-grow absolute ml-[200px] mt-[20px]">
                <h2 className="text-3xl font-bold mb-4">Lawrence Muchilwa</h2>
                <p className="text-lg font-medium">
                  Cybersecurity engineering manager with focus on cyber defend and prevent operations. He leads a cyber security operations center and researches on threat intelligence and forensics.
                </p>
